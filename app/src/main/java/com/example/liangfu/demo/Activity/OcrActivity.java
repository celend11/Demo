...
import com.example.liangfu.demo.Service.RecognizeService;
import com.example.liangfu.demo.Util.FileUtil;
...
//        initAccessTokenWithAkSk();
    ...
    private void initAccessTokenWithAkSk() {
        ...
        }, getApplicationContext(),  "N889lxoPXtWmUPd4Q0G7dY4e", "gtAtjEB79lzPoYhX0gDTaeaLqUIq0mK3");
    }
    ...
    public void toOcr2(View view){
//        Intent intent = new Intent(this, CameraActivity.class);
////        intent.putExtra(CameraActivity.KEY_OUTPUT_FILE_PATH, FileUtil.getSaveFile(getApplication()).getAbsolutePath());
//        intent.putExtra(CameraActivity.KEY_CONTENT_TYPE, CameraActivity.CONTENT_TYPE_ID_CARD_FRONT);
//        startActivityForResult(intent, REQUEST_CODE_CAMERA);
    }
    public void toOcr3(View view){
//        Intent intent = new Intent(this, CameraActivity.class);
//        intent.putExtra(CameraActivity.KEY_OUTPUT_FILE_PATH, FileUtil.getSaveFile(getApplication()).getAbsolutePath());
